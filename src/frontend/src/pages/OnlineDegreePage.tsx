...
import { ArrowLeft, Award, BookOpen, Globe, GraduationCap } from "lucide-react";
...
const highlights = [
  {
    ...
    desc: "Partner universities across USA, UK, Canada, Australia, and Europe.",
  },
  {
    icon: BookOpen,
    title: "Flexible Learning",
    desc: "Study at your own pace with fully accredited online degree programs.",
  },
  {
    icon: Award,
    title: "Recognized Credentials",
    desc: "Degrees recognized by employers and academic institutions worldwide.",
  },
];

export default function OnlineDegreePage() {
  const { data: pages } = useGetAllWebsitePages();
  const pageData = pages?.find((p) => p.slug === "online-degree-courses");
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            ...
            <p className="text-white/70 text-lg max-w-xl mx-auto">
              Pursue accredited international degrees from the comfort of your
              home. We guide you every step of the way.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="p-8 rounded-3xl border-2 border-border bg-accent/30 shadow-card">
              ...
              <p className="text-sm text-foreground/60 mb-6">
                Course materials, guides, and links for the Online Degree
                program. Admin only.
              </p>
              <AdminDropZone
                label="Online Degree Program Materials"
                ocidPrefix="online_degree_resources"
              />
            </div>
          </motion.div>
          ...
          <div className="text-center mt-10">
            ...
            >
              <Link to="/contact" data-ocid="online_degree.primary_button">
